...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const templateParams = {
      ...
      to_email: 'ankit676756@gmail.com',
      date_time: formattedDate,
      user_login: 'AnkitSharma5304'
    };
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:ankit676756@gmail.com" className="text-muted hover:text-light transition-colors">
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:+918394077052" className="text-muted hover:text-light transition-colors">
                    +91 8394077052
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-2">
                    {/* GitHub */}
                    <a href="https://github.com/AnkitSharma5304" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/ankit-sharma-67765228a/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* Twitter */}
                    <a href="https://x.com/AnkitSh31898589" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">

  ...
  const projects = [
    {
      ...
      image: "",
      liveLink: "https://chat-application-psi-seven.vercel.app/",
      highlights: [
        "Developed a performant backend and real-time engine",
        "Secured the authentication system",
        "Resposnsive Frrontend UI",
    ...
    // },
    {
      ...
      tech: ["React", "Prisma", "Google Gemini API", "TailwindCSS", "Puter.JS"],
      image: "",
      liveLink: "https://resume-ai-orpin.vercel.app/",
      highlights: [
        "Integrated Puter.js for seamless user authentication",
        "Architected an AI evaluation system ",
        "Created an ATS scoring and feedback engine",

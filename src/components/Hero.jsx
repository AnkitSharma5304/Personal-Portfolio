        ...
        >
          ...
          >
            ...
            <a href="https://www.codechef.com/users/s_2498" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm text-muted hover:text-light transition-colors">
              <img src="https://cdn.brandfetch.io/idM2-b7Taf/w/400/h/400/theme/dark/icon.jpeg?c=1bxid64Mup7aczewSAYMX&t=1743159643976"
                alt="CodeChef Logo"
                className="w-6 h-6" />
              CODECHEF
            </a>
          ...
          >
            ...
            <a href="/SRI_GANESH_Resume.pdf" target="_blank" rel="noopener noreferrer" className="nothing-btn">
              RESUME
